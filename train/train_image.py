...
weight = ''
save_name = ''
current_dir = os.getcwd() + '\..\weights\weights_image'
...
train_dataset = ImageFolderDataset('../dataset_folder/dataset_Origin/train', feature_extractor)
val_dataset = ImageFolderDataset('../dataset_folder/dataset_Origin/val', feature_extractor)
...
model = ImageClassifier(768, len(train_dataset.classes), weight, 'train').to(device)
